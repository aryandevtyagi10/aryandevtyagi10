...
<div style="display: flex; align-items: center;">
    <div style="flex: 1;">
        <p>Hey there! I'm Aryan, a passionate Computer Science student diving deep into frontend development and problem-solving.</p>
        <p>
            🚀 Exploring new technologies to build innovative projects.<br>
            🛠 Currently learning Python, Java, and JavaScript.<br>
            🎯 Goal: To contribute my skills toward building impactful solutions.<br>
